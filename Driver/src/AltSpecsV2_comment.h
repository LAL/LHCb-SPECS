...
#define    WRITE_IN_PIO_IN                        _IOW('M',0x13,int)
#define	   SET_CONF_TRANSLATION_TABLE             _IO('M',0x14)
#define	   GET_STATE_END_DMA		          _IO('M',0x15)
#define	   SET_LOCK_DMA_BUFFER                    _IO('M',0x16)
#define    SET_UNLOCK_DMA_BUFFER         	  _IO('M',0x17)
